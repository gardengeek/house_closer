...
describe ContactsController do
  ...
  before(:each) do
    controller.stub!(:current_user).and_return(Factory.build(:manager_user))
  end

  describe "GET index" do
    it "assigns all contacts as @contacts" do
      @contacts = [mock_contact]
      Contact.should_receive(:scoped).with() { @contacts }
      @contacts.should_receive(:where).with() { @contacts }
      @contacts.should_receive(:joins).with() { @contacts }
      get :index
